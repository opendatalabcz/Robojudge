          ...
          <Card style={{ ...styles.searchCard, minWidth: '200px' }}>
            <CardContent>
              ...
              <div style={{ marginTop: '42px' }}>
                ...
                <p>Do hlavního textového okna popište případ, pro který mají být nalezeny soudní rozhodnutí řešící podobnou věc. Popis je možné formulovat přirozeným jazykem, ale také heslovitě; pro vyhledávání je důležitý význam nikoli forma. Po rozkliknutí je možné také využít rozšířené vyhledávání pomocí data.</p>
