...
template = """\
    Your task is to summarize the provided court ruling.
    You will receive a part of the court ruling that you should summarize.
    Create your summary in a captivating journalist style.
...
for doc in docs:
    ...
    if len(tokens) <= CONTEXT_SIZE:
        ...
        split_tokens = more_itertools.chunked(tokens, CONTEXT_SIZE)
        split_docs.extend(
            [
...
# print(*split_docs, sep = '\n\n')

res = refiner.combine_docs(split_docs)
